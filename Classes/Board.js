export default class Board {
    ...
    constructor(height, width, winCond) {
        ...
        this.matrix = Board.emptyBoard(height, width);
        this.isOver = false;
    }
    ...
    checkHorizontal(symbol, x, y) {
        ...
        let to = Math.min(this.width - 1, x + (this.winCond - 1));
    ...
    checkVertical(symbol, x, y) {
        ...
        let to = Math.min(this.height - 1, y + (this.winCond - 1));
        for (from; from <= to; from++) {
